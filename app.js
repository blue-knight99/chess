...
function dragDrop(e){
    ...
    if (correctGo) {
        ...
        if (taken && !takenByOpponent) {
            ...
            setTimeout(() => {infoDisplay.textContent="";
...
function checkIfValid(target){
    ...
    switch (piece) {
        case "pawn":
            ...
            if (starterRow.includes(startId) && startId + width *2 === targetId || startId + width === targetId || (startId + width -1 === targetId && document.querySelector(`[square-id="${startId + width -1}"]`).firstChild
            ) ||
